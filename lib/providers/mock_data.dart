...
class MockData {
  ...
  static List<TopConsumer> get topConsumers => [
        const TopConsumer(name: 'Smart TV', ip: '192.168.59.100', consumptionMbps: 42.3),
        const TopConsumer(name: "Juan's MacBook", ip: '192.168.59.255', consumptionMbps: 28.1),
        const TopConsumer(name: 'Server-01', ip: '192.168.59.10', consumptionMbps: 15.7),
        const TopConsumer(name: 'Laptop Dell', ip: '192.168.59.12', consumptionMbps: 8.4),
        const TopConsumer(name: 'Unknown Device', ip: '192.168.59.120', consumptionMbps: 5.2),
      ];
