...
class DeviceProvider extends ChangeNotifier {
  ...
  int get activeDeviceCount => _devices.where((d) => d.status == DeviceStatus.online).length;
  int get totalDeviceCount => _devices.length;
  int get activeAgentCount => _agents.where((a) => a.status == AgentStatus.active).length;
  ...
  Future<void> fetchDevices() async {
    ...
    try {
      ...
      final agentDevices = _devices.where((d) => d.coverage == DeviceCoverage.withAgent);
